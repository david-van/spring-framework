...
public class DispatcherServlet extends FrameworkServlet {
	...
	/**
	 * 用于保存当前 Web 应用程序上下文的请求属性。否则，只能通过标签等获取全局 Web 应用程序上下文
	...
	protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			try {
				//如果是文件上传，将HttpServletRequest-->MultipartHttpServletRequest
				processedRequest = checkMultipart(request);
				//如果为文件上传，那么processedRequest-->MultipartHttpServletRequest,(processedRequest != request)-->true
