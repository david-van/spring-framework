...
public interface TransactionDefinition {
	 ...
	 * 这个是默认的传播行为，通过注解Transactional可以得知
	...
	/**
	 * 支持当前事务，如果没有事务就抛出异常,也就是说当前方法必须在事务中
	...
	/**
	 * 不支持当前事务，如果当前存在事务，直接抛出异常
	 * 和PROPAGATION_MANDATORY 相反，一个是强制要求事务，另外一个是强制不支持事务
